...
.exe-cam-tabs { display: flex; align-items: center; gap: 6px; margin-bottom: 10px; padding: 4px 0; flex-wrap: nowrap; overflow: hidden; }
...
.exe-cam-chip { display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px 6px 10px; border-radius: 20px; cursor: pointer; white-space: nowrap; font-size: 13px; color: #555; background: #fff; border: 1.5px solid #e8e8e8; transition: all .2s; flex-shrink: 0; user-select: none; }
